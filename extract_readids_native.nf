...
process extract_readids_native {

    publishDir "$params.outdir/mappedfastas_native", pattern: "*.fasta", mode:'copy'
    publishDir "$params.outdir/mappedids_native", pattern: "*.txt", mode:'copy'
